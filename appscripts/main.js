...
<br><br>
       ...
       Here, you will experience an interactive narrative (with some mini-games). Various principles and information relating to patents and patent law will be illustrated.<br><br>Leaving me here alone for too long while you go to another tab or window might make me become wonky.<br><br>Hope you will stay till the end, take away something from here, and enjoy!
...
var arrowDownText = paper.text(pWidth/10, pHeight/4*3.5, "⇩").attr({"font-size": 90, "fill": "#000000", "font-family": "Arial", "opacity": 0});
...
let endGame02 = function(){
	...
	singaporeMain.node.addEventListener("click", function myFunction(ev){
		...
		var arrowDownText = paper.text(pWidth/10, pHeight/4*3.5, "⇩").attr({"font-size": 90, "fill": "#FDFF00", "font-family": "Arial", "opacity": 0});
		arrowDownText.animate({opacity:1}, 2000, function(ev){this.animate({"opacity":0},500, function(ev){this.remove()})});
		commentary.innerHTML = `[${new Date().toLocaleTimeString()}] <b>The Talking Lemon</b>: What do the animated lines of binary code represent? Well, apart from them looking rather cool (for me at least) and to make it harder for you to click on the necessary element to proceed, they serve as a reminder of how computer programs have brought about challenges on deciding whether something is patentable. Ohh, that's Africa! Did you know that there are two regional systems on the African continent? They are organised by the African Regional Intellectual Property Organization (ARIPO) and the African Intellectual Property Organization (OAPI).<br>Source:<a href='https://www.lexology.com/library/detail.aspx?g=67bbacc5-4f3c-4e88-bd25-b42bc8aa512e' target= '_blank'><span class='underline'>Lexology</span></a>
			    		<hr>Information presented in this webpage is solely for educational and entertainment purposes only.<br><br>This webpage is powered by HTML5, CSS3, and purely by the Javascript library, Raphaël. This is my first Web animation project!<br><br>All audio and SVG line paths were extracted from works that are in the public domain (sources: freesound.org and freesvg.org). The image files used are created by yours truly.<br><br> © 2021, <a href='https://www.linkedin.com/in/lenon-ong/' target= '_blank'><span class='underline'>Lenon Ong</span></a><br><a href='https://creativecommons.org/licenses/by/3.0/' target= '_blank'><span class='underline'>Available under the Creative Commons Attribution 3.0 Unported License.</span></a><hr>`;
		hitAudio[3].pause();
        hitAudio[3].currentTime = 0;
        hitAudio[3].play();
...
let createAfricaMain = function(){
	...
	africaMain1.node.addEventListener("click", function myFunction(ev){
		...
		var arrowDownText = paper.text(pWidth/10, pHeight/4*3.5, "⇩").attr({"font-size": 90, "fill": "#FDFF00", "font-family": "Arial", "opacity": 0});
		arrowDownText.animate({opacity:1}, 2000, function(ev){this.animate({"opacity":0},500, function(ev){this.remove()})});
		commentary.innerHTML = `[${new Date().toLocaleTimeString()}] <b>The Talking Lemon</b>: The United Kingdom! Computer programs are also helpful in prior art searches. There are various search engines and databases out there that are powered by artificial intelligence (AI)! Oh, me? Nah, I'm not an AI - do I sound artificial to you? Also, I heard that IBM is riding on the wave of non-fungible tokens (NFTs are powered by Blockchain technology) by introducing "NFT Patents"!!<br>Source:<a href='https://www.cnbc.com/2021/04/20/its-no-nba-top-shot-or-beeple-but-ibm-is-making-patent-nfts.html' target= '_blank'><span class='underline'>CNBC</span></a>
			    		<hr>Information presented in this webpage is solely for educational and entertainment purposes only.<br><br>This webpage is powered by HTML5, CSS3, and purely by the Javascript library, Raphaël. This is my first Web animation project!<br><br>All audio and SVG line paths were extracted from works that are in the public domain (sources: freesound.org and freesvg.org). The image files used are created by yours truly.<br><br> © 2021, <a href='https://www.linkedin.com/in/lenon-ong/' target= '_blank'><span class='underline'>Lenon Ong</span></a><br><a href='https://creativecommons.org/licenses/by/3.0/' target= '_blank'><span class='underline'>Available under the Creative Commons Attribution 3.0 Unported License.</span></a><hr>`;
		hitAudio[3].pause();
        hitAudio[3].currentTime = 0;
        hitAudio[3].play();
...
<hr>Information presented in this webpage is solely for educational and entertainment purposes only.<br><br>This webpage is powered by HTML5, CSS3, and purely by the Javascript library, Raphaël. This is my first Web animation project!<br><br>All audio and SVG line paths were extracted from works that are in the public domain (sources: freesound.org and freesvg.org). 
