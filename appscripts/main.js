...
let loadAndShoot = function(){
    ...
    bullet.node.addEventListener("click", function(ev){
		...
		commentary.innerHTML = `[${new Date().toLocaleTimeString()}] <b>The Talking Lemon</b>: If you missed, don't worry! Let's charge up with another patent to overwhelm the enemy!<br><br>I heard patents are granted as fast as 6 months in Singapore. Typically, patents are granted 2-4 years after the date of the filing of patent application (also known as the priority date). Once granted, a patent is granted for TWENTY years from the priority date as the inventor has revealed the invention to the public.<br><br>Source:<a href='https://www.ipos.gov.sg/protect-ip/apply-for-a-patent/accelerated-programmes' target= '_blank'><span class='underline'>Intellectual Property Office of Singapore</span></a>
			    		<hr>Information presented in this webpage is solely for educational and entertainment purposes only.<br><br>This webpage is powered by HTML5, CSS, and purely by the Javascript library, Raphaël. This is my first Web animation project!<br><br>All audio and SVG line paths were extracted from works that are in the public domain (sources: freesound.org and freesvg.org). The image files used are created by yours truly.<br><br> © 2021, <a href='https://www.linkedin.com/in/lenon-ong/' target= '_blank'><span class='underline'>Lenon Ong</span></a><br><a href='https://creativecommons.org/licenses/by/3.0/' target= '_blank'><span class='underline'>Available under the Creative Commons Attribution 3.0 Unported License.</span></a><hr>`;
	    hitAudio[3].pause();
        hitAudio[3].currentTime = 0;
        hitAudio[3].play();
